...
@Component({
  selector: 'app-see-all-rentals-logged-out',
  templateUrl: './see-all-rentals-logged-out.component.html',
  styleUrls: ['./see-all-rentals-logged-out.component.css']
})
export class SeeAllRentalsLoggedOutComponent  implements OnInit{
