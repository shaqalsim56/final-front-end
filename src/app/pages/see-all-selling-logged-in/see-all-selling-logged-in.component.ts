...
@Component({
  selector: 'app-see-all-selling-logged-in',
  templateUrl: './see-all-selling-logged-in.component.html',
  styleUrls: ['./see-all-selling-logged-in.component.css']
})
export class SeeAllSellingLoggedInComponent implements OnInit{
